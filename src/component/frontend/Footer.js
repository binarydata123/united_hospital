      ...
      <div className="footer-part">
        <div className="container">
          <div className="row">
            ...
            <div className="col-sm-3 col-6 colum-3">
              <div className="united-hospital">
                <h3 className="font-width colum-3-h3">CAREER</h3> 
                ...
                <h3 className="font-width">APPOINTMENT <br />PHONE NUMBER:</h3>
