...
import PatientLogin from '../../component/frontend/PatientLogin';
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6 col-sm-3 custom-margin 1">
                ...
                <PatientLogin nextStep={this.nextStep} prevStep={this.prevStep} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6 col-sm-3 custom-margin 2">
                ...
                {/* <PatientIdPopup nextStep={this.nextStep} prevStep={this.prevStep} /> */}
              </div>
            </div>
          </div>
      </div>
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav mb-2 mb-lg-0 ms-auto">
                  ...
                  <li className="nav-item login-white">
                  {
                    ...
                    :
                      <p><a href="#offcanvasExample" data-bs-toggle="offcanvas" role="button" aria-controls="offcanvasExample">Login123/Signup</a> </p>
                  }
                  </li>
