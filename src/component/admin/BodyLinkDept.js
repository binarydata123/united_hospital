																		...
																		this.state.bodyLinkDept.map(body => {
																			return (
																				<tr key={body.id}>
																					...
																					<td>
																						<a href={'/editbodylink/' + body.id}><i className="fa fa-pencil-square"></i></a>
																						{/* <a href={'/viewbodylink/' + body.id}><i className="fa fa-eye"></i></a> */}
																						<a onClick={(e) => this.modalDeleteConfirmOpen(e, body.id)}><i className="fa fa-trash"></i></a>
																					</td>
