...
class addbodylink extends Component {
    ...
    validateForm() {
        ...
        if (!this.state.department_name) {
            formIsValid = false;
            errors["department_name"] = "*Please enter the Department name.";
        }
                                            ...
                                            <form onSubmit={this.handleSubmit} id="editdoctorform" className="needs-validation" noValidate>
                                                ...
                                                <div className="col-sm-9">
                                                    ...
                                                    <div className="col-sm-9">
                                                        <div className="form-group">
                                                            <label>Body</label>
                                                            <select defaultValue={'DEFAULT'} className="form-control" value={this.state.body_part} name="body_part" id="body_part" onChange={this.handleChange}>
                                                            <option value="" selected disabled>Select Body Part</option> 
                                                                 {
                                                                    ...
                                                                    ?
                                                                        this.state.bodyparts.map((bodyparts, index) => {
                                                                            return ( 
                                                                                <option key={bodyparts.id} value={bodyparts.bodypart_id}>{bodyparts.bodypart_name}</option>
                                                                            )
                                                                        })
                                                                    :
                                                                        <option value="" selected disabled>Select Body Part</option>   
