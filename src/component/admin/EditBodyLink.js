...
class EditBodyLink extends Component {
    ...
    validateForm() {
        ...
        if (!this.state.edit_department_name) {
            formIsValid = false;
            errors["edit_department_name"] = "*Please enter the Department name.";
        }
    ...
    refreshEditBodylink = (id) => {
        ...
        .then(res => {
            ...
            if(res.status===true){
                ...
                this.setState({ edit_department_name: records.department_name });
                this.setState({ bodyparts: bodypart.map((rec) => rec) });
                this.setState({ edit_body_part_id: records.bodypart_id });
                
               
            } else {
                this.setState({ gender: '' });
                this.setState({ edit_department_name: '' });
                                                ...
                                                <div className="col-sm-9">
                                                    ...
                                                    <div className="col-sm-9">
                                                        <div className="form-group">
                                                            ...
                                                            <select  defaultValue={'DEFAULT'} className="form-control" value={this.state.edit_body_part_id} name="edit_body_part_id" onChange={this.handleChange}>
                                                            <option value="" selected disabled>Select Body Part</option> 
                                                                {
                                                                    ...
                                                                    ?
                                                                        this.state.bodyparts.map((bodypart) => {
                                                                            return ( 
                                                                                <option key={bodypart.id} value={bodypart.bodypart_id}>{bodypart.bodypart_name}</option>
                                                                            )
                                                                        })
                                                                    :
