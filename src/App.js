...
import { BrowserRouter as Router, Route, Switch,AuthRoute } from 'react-router-dom';
...
import staticpages from './component/admin/staticpages';
    ...
    return (
      <Router> 
        <Switch>
          ...
          <PrivateRoute path="/dashboard/patient-dashboard" component={patientoverview} />
          <PrivateRoute path="/dashboard/appoinments"  component={appointments} />
          <PrivateRoute path="/dashboard/doctor-portal" component={doctorportal} />
          <PrivateRoute path="/dashboard/patient-overview-two" component={patientoverviewtwo} />
          <PrivateRoute path="/dashboard/patient-portal"  component={patientportal} />
          <PrivateRoute path="/dashboard/patient-portal-two"  component={patientportaltwo} />
          <PrivateRoute path="/dashboard/patient-reports"  component={patientreports} />
          
          {/*<Route path="/admindashboard" component={admindashboard} />*/}
          <Route path="/adminlogin" component={adminlogin} />
          <Route path="/adminregister" component={adminregister} />
          {/* <Route path="/popup-register" component={PopupRegister} /> */}
